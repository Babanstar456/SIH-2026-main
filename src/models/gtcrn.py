"""GTCRN - vendored verbatim from https://github.com/Xiaobin-Rong/gtcrn (MIT).

Rong et al., "GTCRN: A Speech Enhancement Model Requiring Ultralow
Computational Resources", ICASSP 2024.

DO NOT EDIT. Local changes belong in wrappers under src/models/ so this file
stays diffable against upstream. Licence text: src/models/LICENSE.gtcrn
Parameter count is measured in src/bench.py, not taken on trust.
"""
"""
